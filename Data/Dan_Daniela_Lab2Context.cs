...
namespace Dan_Daniela_Lab2.Data
{
    public class Dan_Daniela_Lab2Context : DbContext
    {
        ...
        public DbSet<Dan_Daniela_Lab2.Models.Category> Category { get; set; }

        public DbSet<Dan_Daniela_Lab2.Models.Member> Member { get; set; }

        public DbSet<Dan_Daniela_Lab2.Models.Borrowing> Borrowing { get; set; }
    }
}
